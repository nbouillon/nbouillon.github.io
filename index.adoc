...
* link:{basepath}7/OrderMattersAnswers.html[answers]
8. link:{basepath}8/ShortAndSweet.html[Short and Sweet]
* link:{basepath}8/ShortAndSweetAnswers.html[answers]
...
TIP: you can check your round scores in the link:teams/april25teams.html[Teams] page

Any complaints or issues can be directed to Jake.